...
const HeroSlider = ({ images, className }: HeroSliderProps) => {
    ...
    return (
        <div className={`relative overflow-hidden group ${className || "h-screen"}`}>
            ...
            <AnimatePresence mode="wait">
                ...
                >
                    <div className="absolute inset-0">
                        ...
                        />
                        <div className="absolute inset-0 bg-black/5" /> {/* Overlay: Dark semi-transparent layer for readability */}
                    </div>

                    <div className="absolute inset-0 flex items-end justify-center text-center p-4 pb-20">
            ...
            {/* Navigation Arrows */}
            <div className="absolute left-6 top-1/2 -translate-y-1/2 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
                <DiamondArrow direction="left" onClick={prevSlide} />
            </div>
            <div className="absolute right-6 top-1/2 -translate-y-1/2 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
                <DiamondArrow direction="right" onClick={nextSlide} />
            </div>

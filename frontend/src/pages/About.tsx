          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="aspect-[4/5] bg-cream rounded-2xl overflow-hidden">
                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-cream to-champagne">
                  <Diamond className="h-32 w-32 text-accent opacity-30" />
                </div>
              </div>
